...
We note that is a high degree of missingness for certain predictors, such as the "Score" variables. We use the MICE package in R to impute these missing data points. MICE generates multiple imputed datasets, as imputation is a random process.
