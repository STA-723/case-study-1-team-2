...
Testing inclusion of both DDE and PCB vs. control model (p=`r round(control.p[2],3)`). This is a test of the inclusion of both DDE and PCB vs the exclusion of both. This is necessary as DDE and PCB tend to be positively correlated. Marginally in the full model each is at the edge of significance:
