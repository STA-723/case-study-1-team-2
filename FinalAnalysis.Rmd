...
We use package `brant` to test the proportional odds assumption via the Brant Test (@brant1990) (from this post here: https://medium.com/evangelinelee/brant-test-for-proportional-odds-in-r-b0b373a93aa2). The assumption holds at the 0.05 level.
