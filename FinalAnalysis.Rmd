...
knitr::kable(as.data.frame(round(exp(.1*inter_table),3)), caption = "Change in odds ratio for 10% increase in exposure")
```
...
- For 10% increase in the first PC summary of PCBs, the odds of having more normal gestational age decreases by `r round(100 - 100 * exp(.1*inter_table[2,1]),1)`%. See \@ref(fig:Results) below 
