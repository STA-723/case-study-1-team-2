...
- For 10% increase in the first principal components of PCBs, the odds of having more normal gestational age decreases by `r round(100 - 100 * exp(.1*inter_table[2,1]),1)`%. See \@ref(fig:Results) below for a pictoral representation of fitted dose response probabilities across gestational term severities. 
